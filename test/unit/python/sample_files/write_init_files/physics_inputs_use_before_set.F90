...
!>
!! @brief Auto-generated Initial conditions source file, physics_inputs_use_before_set.F90
!!
!
module physics_inputs_use_before_set
...
contains
   ...
   subroutine physics_read_data(file, suite_names, timestep, read_initialized_variables)
      ...
      use phys_vars_init_check_use_before_set, only: phys_var_num, phys_var_stdnames, input_var_names, std_name_len
      use phys_vars_init_check_use_before_set, only: is_initialized
         ...
         suite_required_vars: do req_idx = 1, size(ccpp_required_data, 1)
            ...
            select case (name_idx)
               ...
               case default
                  ...
                  select case (trim(phys_var_stdnames(name_idx)))
                  case ('eddy_length_scale')
                     call check_field(file, input_var_names(:,name_idx), timestep, eddy_len, 'eddy_length_scale', min_difference, &
...
end module physics_inputs_use_before_set
