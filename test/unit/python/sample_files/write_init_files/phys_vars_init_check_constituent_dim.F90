...
!!
!
module phys_vars_init_check_constituent_dim
...
!! Parameterized initialized_vars options - order matters
   ...
   character(len=39), public, protected :: phys_var_stdnames(phys_var_num) = [character(len=39) :: &
...
end module phys_vars_init_check_constituent_dim
