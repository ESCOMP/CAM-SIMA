...
!>
!! @brief Auto-generated Initial conditions source file, physics_inputs_scalar.F90
!!
!
module physics_inputs_scalar
...
contains
   ...
   subroutine physics_check_data(file_name, suite_names, timestep, min_difference, min_relative_value, err_on_fail)
      ...
      use ccpp_constituent_prop_mod,   only: ccpp_constituent_prop_ptr_t
      use phys_vars_init_check_scalar, only: phys_var_num, phys_var_stdnames, input_var_names, std_name_len
      use physics_types_scalar_var,    only: theta
