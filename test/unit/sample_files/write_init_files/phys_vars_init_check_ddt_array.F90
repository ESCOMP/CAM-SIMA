...
private
  ...
  integer, public, parameter :: phys_var_num = 8

  !Max length of physics-related variable standard names:
  integer, public, parameter :: std_name_len = 40

  !Max length of input (IC) file variable names:
  integer, public, parameter :: ic_name_len = 15

  !Array storing all physics-related variable standard names:
  character(len=40), public, protected :: phys_var_stdnames(phys_var_num) = (/ &
  ...
  character(len=15), public, protected :: input_var_names(2, phys_var_num) = reshape((/ &
    '               ', '               ', &
    '               ', '               ', &
    '               ', '               ', &
    '               ', '               ', &
    ...
    'lon            ', '               ', &
    'Q              ', 'Q_snapshot     ', &
    'CLDLIQ         ', 'CLDLIQ_snapshot' /), (/2, phys_var_num/))
