...
CONTAINS
   ...
   subroutine one_banana(nl_unit, mpicomm, mpiroot, mpi_isroot, logunit)
   ...
   end subroutine one_banana

   subroutine two_banana(nl_unit, mpicomm, mpiroot, mpi_isroot, logunit)
      use mpi,            only: MPI_Integer, MPI_Real8
      use shr_nl_mod,     only: shr_nl_find_group_name
      use cam_abortutils, only: endrun
   ...
   end subroutine two_banana


end module two_scheme_banana
