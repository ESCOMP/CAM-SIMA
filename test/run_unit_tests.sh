...
run_unittest test/unit_python/test_cam_config.py
# CAM autogen unit tests:
run_unittest test/unit_python/test_cam_autogen.py
# CAM build cache unit tests:
run_unittest test/unit_python/test_build_cache.py
# Registry generator unit tests:
run_unittest test/unit_python/test_registry.py
# Namelist reader autogeneration unit tests
run_unittest test/unit_python/test_create_readnl_files.py
# Physics variable init (phys_init) generator unit tests:
run_unittest test/unit_python/test_write_init_files.py
# ParamGen atm_in namelist writer unit tests:
run_unittest test/unit_python/test_atm_in_paramgen.py
# CAM history config unit tests
run_unittest test/unit_python/test_hist_config.py
