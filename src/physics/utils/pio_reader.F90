module pio_reader
    ...
    use ccpp_io_reader, only : ccpp_io_reader_t
    ...
    type, extends(ccpp_io_reader_t) :: pio_reader_t
    private
        type(sima_pio_fh_type) :: sima_pio_fh !PIO File handle type
    contains
        procedure :: open_netcdf_file => open_netcdf_file
        procedure :: close_netcdf_file => close_netcdf_file
        procedure :: get_netcdf_var_int => get_netcdf_var_int
        procedure :: get_netcdf_var_real => get_netcdf_var_real
        procedure :: get_netcdf_var_char => get_netcdf_var_char
