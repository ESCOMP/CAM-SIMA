module modal_aerosol_properties_mod
  !-----------------------------------------------------------------------------
  ! Stub module for modal aerosol properties — not yet implemented in CAM-SIMA.
...
contains
  ...
  function constructor(list_idx) result(newobj)
    ...
    nullify(newobj)
    call endrun('modal_aerosol_properties: not implemented in CAM-SIMA')
  end function constructor

  integer function number_transported(self)
    class(modal_aerosol_properties), intent(in) :: self
    number_transported = -1
    call endrun('modal_aerosol_properties%number_transported: not implemented')
  ...
  subroutine get(self, bin_ndx, species_ndx, density, hygro, &
    ...
    call endrun('modal_aerosol_properties%get: not implemented')
  end subroutine get
  ...
  subroutine actfracs(self, bin_ndx, smc, smax, fn, fm)
    ...
    call endrun('modal_aerosol_properties%actfracs: not implemented')
  ...
  subroutine num_names(self, bin_ndx, name_a, name_c)
    ...
    call endrun('modal_aerosol_properties%num_names: not implemented')
  ...
  subroutine mmr_names(self, bin_ndx, species_ndx, name_a, name_c)
    ...
    integer, intent(in) :: bin_ndx, species_ndx
    character(len=*), intent(out) :: name_a, name_c
    call endrun('modal_aerosol_properties%mmr_names: not implemented')
  ...
  subroutine amb_num_name(self, bin_ndx, name)
    ...
    call endrun('modal_aerosol_properties%amb_num_name: not implemented')
  ...
  subroutine amb_mmr_name(self, bin_ndx, species_ndx, name)
    ...
    integer, intent(in) :: bin_ndx, species_ndx
    character(len=*), intent(out) :: name
    call endrun('modal_aerosol_properties%amb_mmr_name: not implemented')
  ...
  subroutine species_type(self, bin_ndx, species_ndx, spectype)
    ...
    call endrun('modal_aerosol_properties%species_type: not implemented')
  ...
  subroutine apply_number_limits(self, naerosol, vaerosol, istart, istop, m)
    ...
    call endrun('modal_aerosol_properties%apply_number_limits: not implemented')
  ...
  subroutine optics_params(self, bin_ndx, opticstype, extpsw, abspsw, asmpsw, absplw, &
    ...
    call endrun('modal_aerosol_properties%optics_params: not implemented')
  ...
  logical function soluble(self, bin_ndx)
    ...
    integer, intent(in) :: bin_ndx
    soluble = .false.
    call endrun('modal_aerosol_properties%soluble: not implemented')
  ...
  function bin_name(self, bin_ndx) result(name)
    ...
    name = ''
    call endrun('modal_aerosol_properties%bin_name: not implemented')
  ...
  subroutine resuspension_resize(self, dcondt)
    ...
    call endrun('modal_aerosol_properties%resuspension_resize: not implemented')
  ...
  subroutine rebin_bulk_fluxes(self, bulk_type, dep_fluxes, diam_edges, bulk_fluxes, &
    ...
    call endrun('modal_aerosol_properties%rebin_bulk_fluxes: not implemented')
  ...
  pure logical function model_is(self, query)
    ...
    model_is = (trim(query) == 'MAM' .or. trim(query) == 'mam')
